...
const nextConfig = {
  ...
  async rewrites() {
    ...
    return [
      ...
      { source: '/api/roles/:path*', destination: `${authUrl}/api/roles/:path*` },
      { source: '/api/roles', destination: `${authUrl}/api/roles` },
      { source: '/api/admin/:path*', destination: `${authUrl}/api/admin/:path*` },
      { source: '/api/admin', destination: `${authUrl}/api/admin` },
      { source: '/api/audit-logs/:path*', destination: `${authUrl}/api/audit-logs/:path*` },
      { source: '/api/audit-logs', destination: `${authUrl}/api/audit-logs` },
      ...
      { source: '/api/support/:path*', destination: `${orderUrl}/api/support/:path*` },
      { source: '/api/support', destination: `${orderUrl}/api/support` },
      { source: '/api/shipping/:path*', destination: `${orderUrl}/api/shipping/:path*` },
      { source: '/api/shipping', destination: `${orderUrl}/api/shipping` },
      ...
      { source: '/api/categories/:path*', destination: `${productUrl}/api/categories/:path*` },
      ...
      { source: '/api/marketing/:path*', destination: `${notificationSendUrl}/api/marketing/:path*` },
      { source: '/api/marketing', destination: `${notificationSendUrl}/api/marketing` },
    ];
  },
};
