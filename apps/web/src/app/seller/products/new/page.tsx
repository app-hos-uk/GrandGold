  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-3xl">
        ...
        <p className="text-gray-500 mb-6">List a new product in your store.</p>
            ...
            <div className="flex gap-2 mb-3">
              ...
              <button
                ...
                onClick={() => {
                  ...
                  const select = document.getElementById('sellerImageType') as HTMLSelectElement;
