...
/**
 * Proxy /api/cart and /api/cart/* to order-service.
 * The order-service mounts the cart router at /api/cart.
...
async function proxy(request: NextRequest, path: string) {
  const url = `${ORDER_SERVICE_URL}/api/cart${path}${request.nextUrl.search}`;
