...
const DEFAULT_ROLES: Role[] = [
  ...
  },
  {
    id: 'manager',
    name: 'Manager',
    description: 'Management access: orders, products, sellers, and reports',
    isSystem: true,
    scope: 'country' as const,
    permissions: [
      'users.view',
  ...
  },
  {
    id: 'staff',
    name: 'Staff',
    description: 'Operational staff: order processing and product viewing',
    isSystem: true,
    scope: 'country' as const,
    permissions: [
  ...
  },
  {
    id: 'support',
    name: 'Support',
    description: 'Customer support: tickets, order lookup, and user lookup',
    isSystem: true,
    scope: 'country' as const,
    permissions: [
      'orders.view',
  ...
  },
  {
    id: 'seller',
    name: 'Seller',
    description: 'Seller access: own products, orders, and inventory',
    isSystem: true,
    scope: 'country' as const,
    permissions: [],
    userCount: 0,
  },
  {
    id: 'influencer',
    name: 'Influencer',
    description: 'Influencer access: own storefront and analytics',
    isSystem: true,
    scope: 'country' as const,
    permissions: [],
    userCount: 0,
  },
  {
    id: 'consultant',
    name: 'Consultant',
    description: 'Consultant access: consultations',
    isSystem: true,
    scope: 'country' as const,
    permissions: [],
    userCount: 0,
  },
  {
    id: 'customer',
    name: 'Customer',
    description: 'Regular customer: orders and profile',
    isSystem: true,
    scope: 'global' as const,
    permissions: [],
    userCount: 0,
